...
public class QuickstartConfiguration {
    ...
    private String endpoint_contabilizarAbonos_Path;
	...
	public String getEndpoint_contabilizarAbonos_Path() {
		return endpoint_contabilizarAbonos_Path;
	}
	public void setEndpoint_contabilizarAbonos_Path(String endpoint_contabilizarAbonos_Path) {
		this.endpoint_contabilizarAbonos_Path = endpoint_contabilizarAbonos_Path;
	}
