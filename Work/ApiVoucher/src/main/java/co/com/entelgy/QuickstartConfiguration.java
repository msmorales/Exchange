...
public class QuickstartConfiguration {
    ...
    private String wsdlConsume_voucher;
	...
	public String getWsdlConsume_voucher() {
		return wsdlConsume_voucher;
	}
	public void setWsdlConsume_voucher(String wsdlConsume_voucher) {
		this.wsdlConsume_voucher = wsdlConsume_voucher;
	}
