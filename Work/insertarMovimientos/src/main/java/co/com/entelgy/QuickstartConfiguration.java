...
public class QuickstartConfiguration {
    ...
    private String endpoint_ordenpago_Path;
	...
	public String getEndpoint_ordenpago_Path() {
		return endpoint_ordenpago_Path;
	}
	public void setEndpoint_ordenpago_Path(String endpoint_ordenpago_Path) {
		this.endpoint_ordenpago_Path = endpoint_ordenpago_Path;
	}
