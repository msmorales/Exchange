...
public class QuickstartConfiguration {
    ...
    private String wsdlConsume_abonos;
    private String endpoint_crearAsientoCF_Path;
	...
	public String getEndpoint_crearAsientoCF_Path() {
		return endpoint_crearAsientoCF_Path;
	}
	public void setEndpoint_crearAsientoCF_Path(String endpoint_crearAsientoCF_Path) {
		this.endpoint_crearAsientoCF_Path = endpoint_crearAsientoCF_Path;
	}
	...
	public String getWsdlConsume_abonos() {
		return wsdlConsume_abonos;
	}
	public void setWsdlConsume_abonos(String wsdlConsume_abonos) {
		this.wsdlConsume_abonos = wsdlConsume_abonos;
	}
	public String getEndpoint_contabilizarAbonos_Path() {
		return endpoint_crearAsientoCF_Path;
	}
	public void setEndpoint_contabilizarAbonos_Path(String endpoint_crearAsientoCF_Path) {
		this.endpoint_crearAsientoCF_Path = endpoint_crearAsientoCF_Path;
	}
