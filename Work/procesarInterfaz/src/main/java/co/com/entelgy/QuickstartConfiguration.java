...
public class QuickstartConfiguration {
    ...
    private String endpoint_SaldoEncargos_Path;
	...
	public String getEndpoint_SaldoEncargos_Path() {
		return endpoint_SaldoEncargos_Path;
	}
	public void setEndpoint_SaldoEncargos_Path(String endpoint_SaldoEncargos_Path) {
		this.endpoint_SaldoEncargos_Path = endpoint_SaldoEncargos_Path;
	}
