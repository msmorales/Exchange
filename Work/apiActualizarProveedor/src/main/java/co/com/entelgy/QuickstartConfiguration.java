...
public class QuickstartConfiguration {
    ...
    private String wsdlConsume_proveeodr;
    private String endpoint_actualizarProveedor_Path;
	...
	public String getWsdlConsume_proveeodr() {
		return wsdlConsume_proveeodr;
	}
	public void setWsdlConsume_proveeodr(String wsdlConsume_proveeodr) {
		this.wsdlConsume_proveeodr = wsdlConsume_proveeodr;
	}
	public String getEndpoint_actualizarProveedor_Path() {
		return endpoint_actualizarProveedor_Path;
	}
	public void setEndpoint_actualizarProveedor_Path(String endpoint_actualizarProveedor_Path) {
		this.endpoint_actualizarProveedor_Path = endpoint_actualizarProveedor_Path;
	}
